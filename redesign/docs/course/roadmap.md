...
R1 completed the teaching-redesign pass for the learner entrypoint and Part 1. R2 completed the Part 2 Research Core rewrite. R3 completed the Part 3 Memory and Skills rewrite. R4 is active for the Part 4 Multi-Agent Delegation rewrite. Parts 5-7 are still current v1 material until their planned R5-R7 rewrites land.
...
3. Continue through Part 2 and Part 3 as R2/R3 rewritten material, then treat Part 4 as current v1 material while R4 is active and Parts 5-7 as current v1 material until R5-R7.
...
R1 makes this shape visible and rewrites Part 1. R2 rewrites Part 2. R3 rewrites Part 3. R4 is active for Part 4, and R5-R9 are planned follow-up phases, so this target shape should not be read as a claim that every Part already follows the new teaching method.
...
Parts 2-3 now follow this contract after R2/R3. Part 4 must satisfy it after R4 completes, and Parts 5-7 must satisfy it after their R5-R7 rewrites. Until then, they remain valid v1 learning material, not finished examples of the new Part contract.
...
- [2026-07-01-phase-r4-course-teaching-redesign.md](../plans/2026-07-01-phase-r4-course-teaching-redesign.md): active R4 implementation plan.
...
- Part 4 current v1 material while R4 is active: [04-multi-agent-delegation.md](../../course/chapters/04-multi-agent-delegation.md), [04-delegation-runtime-lab.md](../../course/labs/04-delegation-runtime-lab.md), [04-delegation-runtime-solution.md](../../course/solutions/04-delegation-runtime-solution.md).
...
- Phase R4 (active): rewrite Part 4 so Multi-Agent Delegation teaches child context isolation and budget accounting through divided research work.
