...
R1 completed the teaching-redesign pass for the learner entrypoint and Part 1. R2 completed the Part 2 Research Core rewrite. R3 completed the Part 3 Memory and Skills rewrite. Parts 4-7 are still current v1 material until their planned R4-R7 rewrites land.
...
3. Continue through Part 2 and Part 3 as R2/R3 rewritten material, then treat Parts 4-7 as current v1 material until R4-R7.
...
R1 makes this shape visible and rewrites Part 1. R2 rewrites Part 2. R3 rewrites Part 3. R4-R9 are planned follow-up phases, so this target shape should not be read as a claim that every Part already follows the new teaching method.
...
Parts 2-3 now follow this contract after R2/R3. Parts 4-7 must satisfy it after their R4-R7 rewrites. Until then, they remain valid v1 learning material, not finished examples of the new Part contract.
...
- [2026-07-01-phase-r3-course-teaching-redesign.md](../plans/2026-07-01-phase-r3-course-teaching-redesign.md): R3 implementation plan.
