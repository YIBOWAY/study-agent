...
- `../course/tracks/langchain/chapters/05-workbench-langchain.md`: LC Part 5 workbench snapshot.
- `../course/tracks/langchain/chapters/06-comparisons-langchain.md`: LC Part 6 comparisons.
- `../course/tracks/langchain/chapters/07-production-langchain.md`: LC Part 7 production contracts.
- `../course/tracks/langchain/capstone/README.md`: LC Capstone.
