...
- Active phase: None. Phase R4 is complete; Phase R5 should start from a new approved plan when the Part 5 teaching rewrite begins.
- Completed runtime/product phases: 8 of 8
- Course teaching redesign: Phase R1, R2, R3, and R4 complete; R5-R9 planned.
