...
- Current verification baseline: post-R8 review/neat-freak pass on 2026-07-10: full redesign suite `215 passed`; Capstone solution/starter tests green (starter still skip-until-implemented); `ruff check .` clean; docs freshness + markdown Python block gate green (setup + Parts 1-7); Capstone covered by `course/capstone/` tests (not markdown gate).
