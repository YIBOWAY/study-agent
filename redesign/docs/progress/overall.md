...
- Active phase: Phase 4 - Multi-Agent and Delegation in progress
...
| Phase 4: Multi-Agent and Delegation | In Progress | `phases/phase-4.md` | Delegation runtime, isolated child contexts, budget accounting, and merge contract. |
