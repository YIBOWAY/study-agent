...
- Course teaching redesign: Phase R1, R2, R3, R4, R5, and R6 complete; R7 active; R8-R9 planned.
...
| Phase R7: Course Teaching Redesign - Part 7 | In Progress | `phases/phase-r7.md` | Rewrite Part 7 Production Readiness around replay, audit, approval, sandbox, docs freshness, and local-first production boundaries. |
