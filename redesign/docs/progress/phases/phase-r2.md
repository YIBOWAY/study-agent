...
- [ ] Chapter/Lab/Solution 02 are rewritten around the citation problem.
- [ ] Part 2 has at least two ASCII diagrams and at least three `[DD]` / `[TRAP]` / `[CHECK]` / `[BIG]` / `[DEEP]` callouts.
- [ ] Lab 02 includes L1 Follow, L2 Modify, and L3 Design exercises with feedback.
- [ ] Solution 02 explains what each assertion proves and why the design matters.
